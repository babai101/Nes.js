function ppu(Display) {
    ...
    this.setPPUCTRL = function(PPUCTRL) {
        ...
        //         break;
        //     case 1:
        //         this.baseNameTblAddr = 0x2400;
        //         break;
        //     case 2:
        //         this.baseNameTblAddr = 0x2800;
        //         break;
        //     case 3:
        //         this.baseNameTblAddr = 0x2C00;
        //         break;
        // }
            ...
            for (var x = 0; x < 8; x++) {
                ...
                if (pixelColorIndex != 0) {
                    ...
                    //Sprite hit logic: non-transparent Sprite over non-transparent BG REGARDLESS of priority
                        ...
                        if ((spritesToDraw[i] == 0) && ((this.ppuStatusBits & 0x40) == 0x00) && this.renderBackground) {
